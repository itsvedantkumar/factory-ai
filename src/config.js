...
const environmentSchema = z.object({
  ...
  OPENCODE_CONFIG: z.string().default("/opt/agent-factory/app/config/opencode.json"),
  OPENCODE_BIN: z.string().default("/usr/local/bin/opencode"),
...
export function loadConfig(environment = process.env) {
  ...
  return {
    ...
    openCodeConfigPath: path.resolve(env.OPENCODE_CONFIG),
    openCodeBin: path.resolve(env.OPENCODE_BIN),
